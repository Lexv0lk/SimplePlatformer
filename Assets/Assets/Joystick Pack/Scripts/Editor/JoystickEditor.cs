...
public class JoystickEditor : Editor
{
    ...
    private void DrawControlPathField()
    {
        EditorGUILayout.PropertyField(controlPath, new GUIContent("Control Path", "Path, where send data from input."));
    }
}